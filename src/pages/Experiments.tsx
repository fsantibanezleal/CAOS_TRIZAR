...
export default function Experiments() {
  ...
  return (
    <section className="tz-prose" style={{ maxWidth: '100%' }}>
      ...
      <p className="tz-note">{es ? 'Los resultados held-out reales (R²/MAPE por salida) se muestran en la página Benchmark y el scatter de paridad en vivo en la pestaña «Surrogate vs física» del App. Las trazas DEM offline y el cruce balance-poblacional↔DEM se incorporan en el siguiente incremento.' : 'The real held-out results (per-output R²/MAPE) are on the Benchmark page and the live parity scatter is in the App’s “Surrogate vs physics” tab. The offline DEM traces and the population-balance↔DEM cross-check are wired in the next increment.'}</p>
